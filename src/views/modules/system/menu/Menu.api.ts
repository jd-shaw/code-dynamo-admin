...
export const existsByPermCode = (permCode) => {
  return defHttp.get<Result<boolean>>({
    url: '/perm/menu/exists-by-perm-code',
    params: { permCode },
  })
}
export const existsByPermCodeNotId = (permCode, id) => {
  return defHttp.get<Result<boolean>>({
    url: '/perm/menu/exists-by-perm-code-not-id',
    params: { permCode, id },
  })
}
